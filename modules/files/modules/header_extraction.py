...
bullet_points = [
    ...
    "F or the CPU to process information, the data must be stored in RAM or ROM.",
    "The function of ROM in computers is to provide information that is fixed and permanent.",
    "This is information such as tables for character patterns to be displayed on the video monitor, or programs that are essential to the working of the computer, such as programs for testing and finding the total amount of RAM installed on the system, or programs to display information on the video monitor."
]

# Generate a slide deck title
title = generate_header(bullet_points, top_n=3)
